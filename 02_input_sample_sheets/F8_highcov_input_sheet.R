...
f8_highcov <- f8_highcov %>%
  mutate(
    ...
    forward_file_name = paste0("03_rename_fastq_files/F8_highcov/", sample_alias, "_", library_name, "_", "run1_R1.fastq.gz"),
    reverse_file_name = paste0("03_rename_fastq_files/F8_highcov/", sample_alias, "_", library_name, "_", "run1_R2.fastq.gz"),
